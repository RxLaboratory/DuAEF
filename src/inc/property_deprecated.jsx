...
DuAEProperty.setValue = function ( prop, value, defaultTime ) {
    ...
    if (prop.numKeys > 0 && isdef( defaultTime )) return DuAEProperty.setValueAtTime(prop, value, defaultTime);
 ...
 */
DuAEBezier.exportToJsxinc = function ( pathProperty, file, offsetToCenter, append, varName ) {
